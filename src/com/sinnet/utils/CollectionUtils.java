...
public abstract class CollectionUtils {
  ...
  /**
   * Return <code>true</code> if any element in '<code>candidates</code>'
   * is contained in '<code>source</code>'; otherwise returns
   * <code>false</code>.
   * 
   * @param source
   ...
   * in '<code>source</code>'. If no element in '<code>candidates</code>'
   * is present in '<code>source</code>' returns <code>null</code>.
  ...
  /**
   * Convert a list to Map,key is specified by method call
   * 
   * @param <T>
   * @param list
   * @param propertyName
   ...
   * @throws Exception
   */
  public static <T> Map<String, T> list2Map(List<T> list, String propertyName) {
    if (list == null || list.size() == 0)
      return null;
    Map<String, T> map = new HashMap<String, T>();

    String getMethodName = ReflectUtils.getGetMethodName(propertyName);
    for (T t : list) {
      Object prop = ReflectUtils.invokeMethod(t, getMethodName, null, null);
